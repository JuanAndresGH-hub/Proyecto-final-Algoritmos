document.addEventListener('DOMContentLoaded', () => {
    ...
    function generateBotResponse(userInput) {
        ...
        botProfilePic.src = "../../imagenes/perfil 7/pfp7.jpg";
    ...
    function generateResponse(userInput) {
        ...
        if (input.includes('hola') || input.includes('buenas')) {
            ...
            return "Soy Maria, y tu como te llamas?";
            ...
            return "Puedo intercambiar mi monitor por uno similar en caracteristicas o valor, tu que ofreces?";
        } else if (input.includes('monitor')) {
            return "Cual monitor es?";
        } else if (input.includes('samsung') || input.includes('lg')) {
            return "Lo siento, pero no puedo intercambiar mi monitor por eso.";
        } else {
