document.addEventListener('DOMContentLoaded', () => {
    ...
    function generateBotResponse(userInput) {
        ...
        botProfilePic.src = "../../imagenes/perfil 4/pfp4.jpg";
    ...
    function generateResponse(userInput) {
        ...
        if (input.includes('hola') || input.includes('buenas')) {
            ...
            return "Soy Kevin, y tu como te llamas?";
            ...
            return "Puedo intercambiar mi apple watch por una similar en caracteristicas o valor, tu que ofreces?";
        } else if (input.includes('smartwatch') || input.includes('smartwatches')) {
            return "Cual smartwatch es?";
        } else if (input.includes('samsung')) {
            return "Lo siento, pero no puedo intercambiar mi smartwatch por eso.";
        } else {
