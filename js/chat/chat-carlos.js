document.addEventListener('DOMContentLoaded', () => {
    ...
    function generateBotResponse(userInput) {
        ...
        botProfilePic.src = "../../imagenes/perfil 3/pfp3.jpg";
    ...
    function generateResponse(userInput) {
        ...
        if (input.includes('hola') || input.includes('buenas')) {
            ...
            return "Soy Carlos, y tu como te llamas?";
            ...
            return "Puedo intercambiar mis airpods por unos similares en caracteristicas o valor, tu que ofreces?";
        } else if (input.includes('auriculares')) {
            return "Cual auriculares son?";
        } else if (input.includes('redmi') || input.includes('gallaxy') || input.includes('freebuds')) {
            return "Lo siento, pero no puedo intercambiar mis airpods por eso.";
        } else {
