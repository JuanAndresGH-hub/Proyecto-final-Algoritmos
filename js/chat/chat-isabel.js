document.addEventListener('DOMContentLoaded', () => {
    ...
    function generateBotResponse(userInput) {
        ...
        botProfilePic.src = "../../imagenes/perfil 8/pfp8.jpg";
    ...
    function generateResponse(userInput) {
        ...
        if (input.includes('hola') || input.includes('buenas')) {
            ...
            return "Soy Isabel, y tu como te llamas?";
            ...
            return "Puedo intercambiar mi mouse por uno similar en caracteristicas o valor, tu que ofreces?";
        } else if (input.includes('mouse') || input.includes('Mouse')) {
            return "Cual mouse es?";
        } else if (input.includes('redragon')) {
            return "Lo siento, pero no puedo intercambiar mi mouse por eso.";
        } else {
