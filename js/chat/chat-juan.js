document.addEventListener('DOMContentLoaded', () => {
    ...
    function generateBotResponse(userInput) {
        ...
        botProfilePic.src = "../../imagenes/perfil 1/imagen de perfil.jpg";
    ...
    function generateResponse(userInput) {
        ...
        if (input.includes('hola') || input.includes('buenas')) {
            ...
            return "Soy Juan Andres, pero me puedes llamar Juan o Andres o como tu quieras, y tu como te llamas?";
            ...
            return "Puedo intercambiar mi laptop Lenovo por una similar en caracteristicas o valor, tu que ofreces?";
        } else if (input.includes('Iphone') || input.includes('iphone')) {
            return "Cual Iphone es?";
        } else if (input.includes(' 7') || input.includes(' 11') || input.includes(' 8') || input.includes(' X') || input.includes(' 6')) {
            return "Lo siento, pero no puedo intercambiar mi laptop por eso.";
        } else {
