document.addEventListener('DOMContentLoaded', () => {
    ...
    function generateBotResponse(userInput) {
        ...
        botProfilePic.src = "../../imagenes/perfil 5/pfp5.jpg";
    ...
    function generateResponse(userInput) {
        ...
        if (input.includes('hola') || input.includes('buenas')) {
            ...
            return "Soy Yenny, y tu como te llamas?";
            ...
            return "Puedo intercambiar mi Mouse Razer por una similar en caracteristicas o valor, tu que ofreces?";
        } else if (input.includes('mouse')) {
            return "Cual mouse es?";
        } else if (input.includes('redragon ')){
            return "Lo siento, pero no puedo intercambiar mi Mouse Razer por eso.";
        } else {
